...
(function(){
	...
	function getFestival(year, month, day){
		...
		var lunarFestivalArr = new Array('春节','元宵节','侗族芦笙节','填仓节','送穷日','瑶族忌鸟节','春龙节、畲族会亲节','中和节','僳僳族刀杆节','佤族播种节','白族三月街','牛王诞','锡伯族西迁节','端午节','阿昌族泼水节','鄂温克族米阔鲁节','瑶族达努节','壮族祭田节 、瑶族尝新节','火把节','乞巧节','侗族吃新节','中元节','中秋节');
		...
		var lunarFestivalDateArr = new Array('正月初一','正月十五','正月十六至二十','正月二十五','正月二十九','二月初一','二月初二','二月二','二月初八','三月十五','三月十五至二十五','四月初八','四月十八','五月初五','五月十三','五月二十二','五月二十九','六月初六','六月二十四','七月初七','七月十三','的七月十五','八月十五');
